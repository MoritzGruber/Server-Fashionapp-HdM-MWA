angular.module('fittshot.directives', [])
    .directive('pullToRefresh', pullToRefresh);

function pullToRefresh() {
    return {
        templateUrl:'components/directives/pulltorefresh.html',
        transclude: true,
        scope: {
            updateFn: '&',
        ...
        link: function (scope, element) {
            ...
            function configuration() {
                ...
                scope.frameTop = angular.isDefined(scope.frameTop) ? scope.frameTop : 0;
                configureView();
